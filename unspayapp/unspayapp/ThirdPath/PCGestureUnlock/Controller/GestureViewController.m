...
- (void)setupSubViewsLoginVc
{
    ...
    [self creatButton:leftBtn frame:CGRectMake(CircleViewEdgeMargin + 20, kScreenH - 60, kScreenW/2, 20) title:@"忘记手势?" alignment:UIControlContentHorizontalAlignmentLeft tag:buttonTagManager];
