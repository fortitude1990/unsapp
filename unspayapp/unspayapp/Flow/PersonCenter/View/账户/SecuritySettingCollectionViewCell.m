...
@interface SecuritySettingCollectionViewCell()
...
@implementation SecuritySettingCollectionViewCell
...
- (void)createUI{
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.equalTo(@(kAutoScaleNormal(54)));
    ...
    titleLabel.textColor = KHexColor(0x5f5f5f);
...
- (void)setDataSource:(SecuritySettingItemModel *)dataSource{
